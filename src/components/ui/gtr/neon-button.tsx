...
export const NeonButton = ({ 
  ...
  const variants = {
    ...
    tertiary: "bg-pickle-tertiary/5 border-white/10 text-pickle-tertiary/90 hover:bg-pickle-tertiary hover:text-white hover:border-pickle-tertiary hover:shadow-[0_8px_30px_rgb(0,45,114,0.4)] shadow-inner",
